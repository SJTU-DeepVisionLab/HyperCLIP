...
class CATSeg(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            #ortho_loss = sum(self.l1_penalty(param) for name, param in self.sem_seg_head.predictor.clip_model.named_parameters() if 'base' in name)
