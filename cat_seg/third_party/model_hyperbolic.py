...
from .hyperbolic import set_adapter_hyperbolic, set_adapter_vision_hyperbolic
...
class CLIP(nn.Module):
    def __init__(self,
        ...
        set_adapter_hyperbolic(self.transformer, dim=128, hidden_size=transformer_width, length=12)
        set_adapter_vision_hyperbolic(self.visual, dim=128, hidden_size=vision_width, length=12)
